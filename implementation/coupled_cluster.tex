...
conda activate cc
\end{lstlisting}
Full documentation, which we hope will be kept up to date with any future revisions 
...
\subsection{Integrators and ODE Solvers}
    ...
    We have already derive the equations of motions for several coupled 
    ...
    For the user of the Gauss integrator, the experience will be much better, but the 
    operations performed are the same, as evidenced by the \lstinline{GaussIntegrator}
    class specification. 
