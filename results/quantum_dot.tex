...
This 
includes exhibiting only one frequency in the dipole spectrum of the system. If 
we compute the Fourier transform of the dipole of an $n$-electron quantum dot with 
...
to $\Omega=1$ and the frequency of the electric field to $\omega=2\Omega=2$. We 
...
unreasonable at some time step after $t=6 \text{ au}$. This result is similar to
...
The system is allowed to develop in time for $T = 100 \text{ au}$. We compute the Fourier 
