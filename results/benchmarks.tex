...
set\footnote{See basis set description in for instance
...
to multiples of Bohr radii here.
...
7 in Pedersen and Kvall \cite{pedersen2019symplectic}.
...
The total time of the simulation is $T=331 \text{ au}$. Both the unit for frequency and 
