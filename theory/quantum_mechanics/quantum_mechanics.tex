...
\subsection{The Dirac-von Neumann Postulates}
    ...
    To conlcude the description of quantum states for now; a state function $\psi$ is said 
    ...
    \end{equation}
    leads to a different, but equivalent representations of a quantum system.
