...
and
\citeauthor{hugenholtz1957perturbation} \cite{hugenholtz1957perturbation}.
...
diagrams, which is done in Shavitt and Bartlett \cite{shavitt2009many}, for instance.
...
\begin{gather}
    ...
    \end{aligned}
\end{gather}
Inserting this result into the original expression and substituting similar indices
yields,
\begin{equation}
...
There are four reasonable groups into which to sort the
...
The Coupled Cluster Singles Doubles (CCSD) equations take the form 
\begin{gather}
    \bra{\Phi_0} \hat{H}_N
...
We can write down the equations of motions just for the nonzero $P$-components
